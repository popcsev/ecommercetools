...
- [Basket Analysis (Apriori)](#basket-analysis-apriori) - **NEW**
---
...
**NEW:** Market basket analysis helpers powered by `mlxtend`.

Use these functions from `ecommercetools.marketing`:
...
```python
import pandas as pd
from ecommercetools.marketing import (
    create_basket_matrix,
    get_frequent_itemsets,
    get_association_rules,
)

# transaction_items must contain at least order_id + sku
...
basket = create_basket_matrix(
    ...
    sku_column="sku",
    quantity_column="quantity",  # optional
)

itemsets = get_frequent_itemsets(
    transaction_items,
    order_id_column="order_id",
    sku_column="sku",
